...
<script src="<?= base_url('js/pages/listdata_users.js') ?>"></script>
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-4">
                        <h5 class="card-title mb-0">Daftar akun saat ini</h5>
                    </div>
                    <div class="col-md-8 mt-3">
                        <?php if (!in_groups('anggota')) : ?>
                            <a href="<?= base_url('users/form') ?>" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Add</a>
                        <?php endif ?>
                    </div>
                </div>
            </div>
                    ...
                    <table id="tabledata" class="table table-striped" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="wrap-max-40">Username</th>
                                <th class="wrap-max-40">Role</th>
